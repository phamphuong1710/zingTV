				            ...
				            <table id="bootstrap-data-table" class="table table-striped table-bordered">
				                ...
				                <tbody>
				                	<?php foreach ($program as $key => $value) {?>
					                  	<tr >
						                    <td>
						                    	<img src="<?php echo base_url().'image/'.$value->anh ?>" height="80">
						                    </td>
						                    <td>
						                    ...
						                    <td>
						                    	<?php echo $value->idtheloai; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->idloaichuongtrinh; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->quocgia; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->daodien; ?>
						                    </td>
						                    <td>
						                    	<div style="height:150px;overflow-y: scroll;">
						                    		<?php echo $value->dienvien; ?>
						                    		
						                    	</div>
						                    </td>
						                    <td>
						                    	<?php echo $value->namphathanh; ?>
						                    </td>
						                    <td>
						                    	<?php echo $value->thoiluong; ?>
						                    </td>
						                    <td >
						                    	<div style="height:150px;overflow-y: scroll;">
						                    		<?php echo $value->mota ?>
						                    ...
						                    <td>
						                    	<a href="<?php echo base_url().'/Admin/editProgram/'.$value->id ?>">
						                    		<i class="fa fa-edit"></i>
						                    	</a>
						                    	 &#8196 &#8196
						                    	<a href="<?php echo base_url().'/Admin/deleteProgram/'.$value->id ?>">
