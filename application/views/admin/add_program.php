                ...
                <div class="col-md-6 col-md-offset-6">
                    <div class="card">
                        ...
                        <div class="card-body card-block">
                            <form action="<?php echo base_url().'Admin/addProgram' ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="tenchuongtrinh" placeholder="Tên chương trình" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="email-input" name="quocgia" placeholder="Quốc Gia" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                ...
                                <div class="row form-group">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="password-input" name="daodien" placeholder="Đạo Diễn" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="input" name="dienvien" placeholder="Diễn viên"  class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                    ...
                                    <div class="col-12 col-md-9">
                                        <input type="text" id="password-input" name="thoiluong" placeholder="Thời lượng" class="form-control">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="col col-md-3">
                                            ...
                                            <?php foreach ($genre as $key => $value) {?>
                                                <div class="checkbox">
                                                    <label for="checkbox1" class="form-check-label ">
                                                        <input type="checkbox" id="checkbox1" name="theloai[]" value="<?php echo $value->id ?>" class="form-check-input">
