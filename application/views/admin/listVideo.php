				            ...
				            <table id="bootstrap-data-table" class="table table-striped table-bordered">
				                ...
				                <tbody>
				                	...
				                	<?php foreach ($video as $key => $value) {?>
					                  	<tr >
						                    <td>
						                    	<img src="<?php echo base_url().'image/video/'.$value->anh ?>" height="80">
						                    </td>
						                    <td>
						                    	<?php echo $value->id_tenchuongtrinh  ?>
						                    ...
						                    <td>
						                    	<a href="<?php echo base_url().'/image/video/'.$value->video ?>"><i class="fa fa-play" style="font-size:24px"></i></a>
						                    </td>
						                    <td>
                                            ...
                                            <td>
                                                <a href="<?php echo base_url().'Admin/deleteVideo/'.$value->id ?>">
